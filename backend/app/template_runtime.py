...
from app.routes.microsoft_accounts import accounts_for_run_config as _microsoft_accounts_spec
    ...
    with get_connection() as conn:
        ...
        if version is None:
            return {
                ...
                "microsoft_accounts": _microsoft_accounts_spec(conn, tenant_id),
